...
function CarSpec() {
  ...
  return (
    <div className="flex flex-col md:flex-row gap-10 md:gap-20 py-10 border-b border-gray-200 relative w-full hover:border-accent transition-all duration-300">
      <Link href="/motors/1" className="absolute top-0 left-0 w-full h-full"/>
      ...
      <div className="flex flex-col gap-2 text-lg text-primary">
        <span className="font-bold">4000,000 RWF</span>
        <div className="flex gap-2 items-center">
          <span>Benz Mercedes</span>
          <span className="w-2 h-2 rounded-full bg-accent" />
          <span>G wagon</span>
        </div>
        <div className="flex gap-2 flex-col md:flex-row">
            <span className="md:separator flex items-center">Benz Mercedes G Wagon 2021</span>
          <span className="md:separator flex items-center">Automatic</span>
          <span className="md:separator flex items-center">AC</span>
          <span className="md:separator flex items-center">Left hand drive</span>
        </div>
